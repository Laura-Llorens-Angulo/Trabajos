...
public class ClienteValoracionesWS {
    ...
    public static void main(String[] args)  {
        ...
        try {
            AuxiliarValoracionesWS auxiliar = new AuxiliarValoracionesWS();
     ...
     * @param auxiliar
     */
    private static void guardarDatosYTerminar(AuxiliarValoracionesWS auxiliar)  {
     ...
     * @param auxiliar
     */
    private static void listarNombresRestaurantes(AuxiliarValoracionesWS auxiliar) throws ParseException {
     ...
     * @param auxiliar
     */
    private static void consultaValoracionesRestaurantePorNombre(AuxiliarValoracionesWS auxiliar, Scanner teclado) throws ParseException {
     ...
     * @param auxiliar
     */
    private static void crearValoracion(AuxiliarValoracionesWS auxiliar, Scanner teclado, String codcliente) throws ParseException {
     ...
     * @param auxiliar
     */
    private static void borrarValoracion(AuxiliarValoracionesWS auxiliar, Scanner teclado, String codcliente) throws ParseException {
        System.out.print("Introduce el nombre del restaurante: ");
        String nomRest = teclado.nextLine();
     ...
     * @param auxiliar
     */
    private static void modificarValoracion(AuxiliarValoracionesWS auxiliar, Scanner teclado, String codcliente) throws ParseException {
        System.out.print("Introduce el nombre del restaurante: ");
        String nomRest = teclado.nextLine();
        String fecha = leeFecha(teclado);
        long estrellas = leeEstrellas(teclado);
